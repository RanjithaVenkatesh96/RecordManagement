...
select Attendance.stud_id,CONCAT(stud_name,' ',IFNULL(stud_father_name,''),' ',IFNULL(stud_surname,'')) as stud_name,stud_rollno,stud_enrolmentno,sum(presence) as presence,count(presence) as total,ROUND((sum(presence) / count(presence))*100,2) as percentage from Attendance 
join Student_Master
...
('admin', 'admin@ams.com', 1, 1, '1024823780535d64ce7fd332.53283497', '9eb62f5887240a9bd354d1a8a5d7d5ff863158184282c655c5334b7cf500e40b81cd46f7c6d808fb13b03c2bb04bfba0b55896f9c98931fab39cb2bd34b5c10e', 1, '2014-04-28 01:43:02', '2014-04-27 20:13:02', NULL, 1),
('developer', 'ranjithav201396@gmail.com', 1, 1, '5502270520611a146ed63.60627028', '5bfa6548ed74bfe9bb8396e52d10222ca274eb8376a2b24d323a7a5a7cd5c368f1f1c2163cca172a6f836d727c7a77fa4e7ced9ff0a53caf120071f15604ed75', 0, '2013-09-22 00:00:00', '2014-02-07 11:32:25', NULL, 1);
